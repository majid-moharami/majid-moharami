...
function buildArchitectSvg() {
  ...
  <defs>
    ...
    <style>
      ...
      .metric-box { fill: #161b22; stroke: #30363d; stroke-width: 1; rx: 6px; }
      ...
      .lbl-val { fill: ${TEXT}; font-size: 14px; font-weight: 700; font-family: ui-monospace, SFMono-Regular, monospace; }
      ...
      .status-pill { fill: #1f6feb; fill-opacity: 0.15; stroke: #38bdf8; stroke-width: 1; rx: 6px; }
      .status-text { fill: #38bdf8; font-size: 10px; font-weight: 600; font-family: ui-monospace, SFMono-Regular, monospace; }
      .live-dot { fill: ${ACCENT_GREEN}; animation: pulseGlow 1.5s infinite; }
  ...
  <!-- Title & Status -->
  <text x="${WIDTH / 2}" y="${TITLEBAR_H / 2 + 4}" text-anchor="middle" class="title-text">⚡ Engineering Impact &amp; Metrics</text>
  ...
  <g class="anim-row" style="animation-delay: 0.05s">
    <text x="${PAD_X}" y="${TITLEBAR_H + 20}" class="sec-title">SCALE &amp; RELIABILITY</text>
  ...
  <g class="anim-row" style="animation-delay: 0.15s">
    <text x="${PAD_X}" y="${TITLEBAR_H + 168}" class="sec-title">CORE ARCHITECTURE &amp; STACK</text>
    ...
    <text x="${PAD_X}" y="${TITLEBAR_H + 224}" class="skill-name">Jetpack Compose &amp; Modern UI</text>
    ...
    <text x="${PAD_X}" y="${TITLEBAR_H + 292}" class="skill-name">CI/CD • Gradle • Unit/UI Tests</text>
